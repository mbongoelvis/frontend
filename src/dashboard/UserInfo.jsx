...
export const UserInfo = () => {
  return (
    <div className="bg-white rounded-xl px-8 w-[60%] pt-8">
      ...
      <div className="w-full min-h-12 bg-gray-50 py-5 mt-5 rounded-xl px-3 flex items-center justify-between">
        ...
        <div className="h-[200px] w-1/4 rounded-xl border-2 border-blue-500 border-dotted overflow-hidden flex items-center justify-center reltive">
          <input
            type="file"
